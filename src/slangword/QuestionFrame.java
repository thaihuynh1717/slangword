...
public class QuestionFrame extends JFrame implements ActionListener {
	...
	QuestionFrame(int type) {
		...
		// A Label
		JLabel label = new JLabel("Find the correct answer");
		...
		if (type == 1)
			questionLabel = new JLabel("What does  " + "`" + s[0] + "`" + " slang word's mean?");
		else
			questionLabel = new JLabel("What is the slang word of " + s[0] + " ?");
