...
//		// System.out.println(s[0] + "\t" + s[1]);
		...
		lb1.setFont(new Font("Sans-serif", Font.PLAIN, 35));
		lb2.setFont(new Font("Sans-serif", Font.PLAIN, 35));
		lb3.setFont(new Font("Sans-serif", Font.PLAIN, 35));
		lb4.setFont(new Font("Sans-serif", Font.PLAIN, 35));
		// slangLabel.setFont(new Font("Sans-serif", Font.PLAIN, 35));
		slangPanel.add(lb1);
		slangPanel.add(lb2);
		slangPanel.add(lb3);
		slangPanel.add(lb4);
