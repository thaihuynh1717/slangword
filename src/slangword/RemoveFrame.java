...
public class RemoveFrame extends JFrame implements ActionListener, ListSelectionListener {
	JButton btnBack;
	JTable jt;
	SlangWord slangWord;
	...
	public RemoveFrame() throws Exception {
		Container con = this.getContentPane();
		slangWord = SlangWord.getInstance();

		// Label
		JLabel titleLabel = new JLabel();
		titleLabel.setText("REMOVE A SLANG WORD");
		...
		String column[] = { "STT", "SlangWord", "Definition" };
